...
/**
 * Generated by Tencent, 生成天御登录保护的URL
 * @author Jin Song
 *
 */
public class TianYuLoginProtectUtils extends TianYuBaseUtils {
    ...
    */
    ...
    public static String makeMobileNoURL(String mobileNo, String loginIp) throws InvalidKeyException, NoSuchAlgorithmException, UnsupportedEncodingException {
        return makeMobileNoURL(mobileNo, loginIp, System.currentTimeMillis() / 1000);
    }

    public static String makeMobileNoURL(String mobileNo, String loginIp, long timeStamp) throws InvalidKeyException, NoSuchAlgorithmException, UnsupportedEncodingException {
        ...
        /* 行为信息参数 */
        args.put("loginIp", loginIp);
        args.put("loginTime", timeStamp > 0 ? String.valueOf(timeStamp) : String.valueOf(System.currentTimeMillis() / 1000));

        /* 设备信息参数 */

        /* 其他信息参数 */

        return makeURL("GET", "LoginProtection", "gz", Constants.TIANYU_SECRET_ID, Constants.TIANYU_SECRET_KEY, args, "utf-8");
    }
}