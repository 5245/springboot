 ...
 *
 */
@Api(value = "/getpdabyid")
@Path("/getpdabyid")
public class UserDeliveryAddrGetByIDController extends BaseController {

    private static final Logger     logger = LoggerFactory.getLogger(UserDeliveryAddrGetByIDController.class);
    ...
    public Response getPDAByID(UserDeliveryAddrCRUDReq reqJava) {
        ...
        checkParam(reqJava);
        // 根据uid与id查询对应的收货地址
        UserDeliveryAddrCRURes resObj = userDeliveryAddrService.queryUserDeliverAddrById(reqJava);
