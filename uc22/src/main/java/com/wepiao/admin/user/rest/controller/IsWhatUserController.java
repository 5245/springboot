 ...
 *
 */
@Api(value = "/getstatictag")
@Path("/getstatictag")
public class IsWhatUserController extends BaseController {

    private static final Logger logger             = LoggerFactory.getLogger(Constants.LOG_USER_TAG);

    //ucopen静态标签查询访问地址
    private static final String GET_STATIC_TAG_URL = Constants.UCOPEN_URL + "getstatictag";
    ...
    public Response isWhatUser(String req) {
        ...
        String response = HttpAsyncUtil.post(GET_STATIC_TAG_URL, req, headers);
