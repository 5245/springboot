...
/**
 * Generated by Tencent, 生成防黄牛的URL
 * @author Jin Song
 *
 */
public class TianYuAntiRushUtils extends TianYuBaseUtils {
    ...
    */
    ...
    public static String makeURL(
        ...
        String charset) throws InvalidKeyException, NoSuchAlgorithmException, UnsupportedEncodingException
    {
    ...
    public static String makeMobileNoURL(String mobileNo, String userIp) throws InvalidKeyException, NoSuchAlgorithmException, UnsupportedEncodingException {
        return makeMobileNoURL(mobileNo, userIp, System.currentTimeMillis() / 1000);
    }
    
    public static String makeMobileNoURL(String mobileNo, String userIp, long timeStamp) throws InvalidKeyException, NoSuchAlgorithmException, UnsupportedEncodingException {
        ...
        /* 行为信息参数 */
        args.put("userIp", userIp);
        args.put("postTime", timeStamp > 0 ? String.valueOf(timeStamp) : String.valueOf(System.currentTimeMillis() / 1000));

        /* 设备信息参数 */

        /* 其他信息参数 */

        return makeURL("GET", "ActivityAntiRush", "gz", Constants.TIANYU_SECRET_ID, Constants.TIANYU_SECRET_KEY, args, "utf-8");
    }
