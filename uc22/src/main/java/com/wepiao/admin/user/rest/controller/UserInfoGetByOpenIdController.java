 ...
 *
 */
@Api(value = "/getuserinfobyopenid")
@Path("/getuserinfobyopenid")
public class UserInfoGetByOpenIdController extends BaseController {
    ...
    public Response getUserInfoByOpenId(UserInfoGetByOpenIdReq reqJava) {
        ...
        UserInfoGetRes resObj = userInfoQueryService.getUserByOpenId(reqJava);
    ...
    private void checkParam(UserInfoGetByOpenIdReq req) {
