 ...
 *
 */
@Api(value = "removecinematofavorites", produces = "application/json")
@Path("/removecinematofavorites")
public class CinemaFavoriteRemoveController extends BaseController {

    private static final Logger   logger = LoggerFactory.getLogger(CinemaFavoriteRemoveController.class);
    ...
    public Response removeCinemaFavorite(CinemaFavoriteRemoveReq reqJava) {
        ...
        SingleResultRes resObj = cinemaFavoriteService.removeCinemaFromFavorites(reqJava);
    ...
    private void checkParam(CinemaFavoriteRemoveReq req) {
