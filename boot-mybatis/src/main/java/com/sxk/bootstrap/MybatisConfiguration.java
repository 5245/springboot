...
public class MybatisConfiguration {
     ...
     *
     */
    private void configSessionFactory(SqlSessionFactoryBean sessionFactory) {
    ...
    public SqlSession sqlSessionLegacyUsers(@Qualifier("dataSourceLegacy") DruidDataSource dataSourceLegacy) throws Exception {
        ...
        configSessionFactory(sessionFactory);
    ...
    //        configSessionFactory(sessionFactory1);
    ...
    //        configSessionFactory(sessionFactory2);
    ...
    //        configSessionFactory(sessionFactory3);
    ...
    //        configSessionFactory(sessionFactory4);
    ...
    //        configSessionFactory(sessionFactory5);
    ...
    //        configSessionFactory(sessionFactory6);
    ...
    //        configSessionFactory(sessionFactory7);
